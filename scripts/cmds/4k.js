...
const API_ENDPOINT = "https://api.deepai.org/api/waifu2x";
...
module.exports = {
  ...
  onStart: async function ({ args, message, event }) {
    ...
    try {
      // 1. Call DeepAI waifu2x API (free tier, no key required for basic use)
      ...
      const upscaledImageUrl = data.output_url || data.imageUrl || data.image || data.url;
      if (!upscaledImageUrl) {
