...
module.exports.onStart = async function ({ api, event, args }) {
  ...
  if (!admins.includes(event.senderID)) {
    return api.sendMessage(
      "❌ Only my boss SHAKIL can use this command!",
      event.threadID,
      event.messageID
    );
  }
  ...
  if (args[0] === "on") {
    ...
    const msg = `✅ ওকে 𓆩𝗦𝗵𝗮𝗸𝗶𝗹𓆪 বস 𓆩»${name}«𓆪\nএই খানকির পোলা SMS করলেই চুদা ফ্রী`;
...
module.exports.onChat = async function ({ api, event }) {
  ...
  const messages = [
    ...
    "\nআমার 𓆩𝗦𝗵𝗮𝗸𝗶𝗹𓆪 বস তোর মা কে চুদে পল্টি মারবো! 😡",  
    "\nতোর মার গুদে ফুল ট্যাবলেট পুশ করবো! 🤡",  
    "\nতোর মার ভোদায় 𓆩𝗦𝗵𝗮𝗸𝗶𝗹𓆪 বস গাধার মতো মাল ফালিয়ে দিবে!🔥",  
    "\n𓆩𝗦𝗵𝗮𝗸𝗶𝗹𓆪 বস তোর মাকে গাধার মতো চুদে বলবো এটা কার মাল? 😂",  
    "\nএই খানকির পোলা বেশ্যার পোলা তোর মাকে চুদে আমার বস momin সারা বেলা,🖕💯",  
    "\nবস 𓆩𝗦𝗵𝗮𝗸𝗶𝗹𓆪 বস তোর মার গুদে ইনপুট দিয়ে আউটপুট নেবো! 💀",  
    "\nআম পাতা জোড়া জোড়া তোর মাকে চূদে আমার বস 𓆩𝗦𝗵𝗮𝗸𝗶𝗹𓆪 উরাধুরা..!🖕💯",
    "\nতুই নাকি অনলাইনের কিং তোর মায়ের ভোদা মধ্যে বাজামু সাপের বিন বিনের তালে তালে চুদতে চুদতে নিয়া যামু খালে খালে নাই সাপ আমার বস শাকিল তোর অবৈধ বাপ💦👅..",
    ...
    "\nএই মুরগি খাংকির পোলা 𓆩𝗦𝗵𝗮𝗸𝗶𝗹𓆪 বস তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস..!!",
    "\nখাংকির পোলা তুই 𓆩𝗦𝗵𝗮𝗸𝗶𝗹𓆪 বস কে গালি দেস তুই তো রাস্তার পতিতার পুত ছোডো ভাই তর আম্মু রে টুস করে চুদে দিয়ে দূর দিভো 🐒🙈?",
